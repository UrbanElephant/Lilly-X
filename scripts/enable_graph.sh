...
echo "🔌 ENABLING KNOWLEDGE GRAPH (NEO4J)..."

cat << 'EOF' > scripts/start_neo4j.sh
#!/bin/bash
set -e
...
echo "=================================================="
echo "🧠 GRAPH DATABASE ONLINE."
echo "👉 CRITICAL: You must RE-RUN ingestion to populate the graph."
echo "   Command: ./run_ingestion.sh"
echo "=================================================="
